...
takes in the courseInfo object and
...
Write a function named checkValues that
takes in an object and a value and
returns
...
// const updateNumbers = (obj) => [...(Object.entries( obj ))]
const updateNumbers = (obj) =>
  [...(Object.keys(obj).map((key, index) => key + ': ' + Object.values(obj)[index]))];
...
Write a function named getHouses that
returns a new array containing the names
...
------------------------------------------------------------------------------------------------ */
// ###### It should return true for characters that have children (1 ms)
